...
Store design references with provenance and a clear proposed/approved designation. Illustrative values are not seed data.

## Sprint designs

- [Sprint 003 category status matrix](category-status-matrix.md): original concept image and subsequent refinements.
