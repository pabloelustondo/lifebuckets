...
test('map layout, exact taxonomy, keyboard and independent categories',async({page})=>{
 ...
 await page.screenshot({path:'docs/09-build-and-test/sprint-003-evidence/collapsed-420.png',fullPage:true});
 ...
 for(const width of [320,1440]){
  ...
  await page.screenshot({path:'docs/09-build-and-test/sprint-003-evidence/expanded-'+width+'.png',fullPage:true});
 }
...
test('trusted profile survives a real browser restart offline',async({},info)=>{
 ...
 try{
  ...
  await resumed.screenshot({path:'docs/09-build-and-test/sprint-003-evidence/offline-restart.png',fullPage:true});
